...
type Props = {
  ...
  showEmpathyButton?: boolean;
  empathyDisabled?: boolean;
};
...
export default function ReviewDetailModal({
  ...
  onClose,
  onEmpathy,
  showEmpathyButton = true,
  empathyDisabled = false,
}: Props) {
    ...
    <AnimatePresence>
      {open && (
        ...
        >
          {/* 모달 박스 */}
          <motion.div
            className="relative w-[539px] bg-white rounded-sm overflow-hidden shadow-xl my-10"
            // 필요하면 my-10 → my-16 으로 더 아래로 내릴 수도 있음
