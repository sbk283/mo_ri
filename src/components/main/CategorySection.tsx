      ...
      <div className="mx-auto w-[1024px]">
        ...
        <div className="flex justify-center gap-8">
          ...
          >
            ...
            <span className="text-sm font-medium">운동/건강</span>
          </div>
          ...
          >
            ...
            <span className="text-sm font-medium">스터디/학습</span>
          </div>
          ...
          >
            ...
            <span className="text-sm font-medium">취미/여가</span>
          </div>
          ...
          >
            ...
            <span className="text-sm font-medium">봉사/사회참여</span>
          </div>
        </div>
      </div>
    </div>
