            ...
            <div className="w-[1024px] h-[100%] pt-[54px] px-[77px] pb-[65px] border-gray-300 border-[1px] rounded-[5px] mx-auto">
              ...
              <div className="text-md">
                ...
                <div>
                  <b>제2조(서비스 내용)</b>
                  <br />
                  1. 이용자의 현재 위치 또는 지정 위치를 기반으로 한 주변 모임 검색·추천 <br /> 2.
                  모임 경로 안내, 체크인(출석), 안전 안내, 위치 기반 알림 <br />
                ...
                <div>
                  ...
                  <br />
                  3. 제3자 제공: 원칙적으로 동의 없이 제공하지 않으며, 제공 필요 시 사전 고지 및
                  동의
                </div>
                <br />
                <div>
                  ...
                  <br />
                  2. 설정에서 언제든 동의를 철회할 수 있으며, 철회 시 관련 서비스가 제한될 수
                  있습니다.
                </div>
                <br />
                <div>
                ...
                <div>
                  ...
                  <br />
                  개인위치정보주체는 열람·고지 요구, 정정·삭제, 일시 중지 요구, 동의 범위 설정·철회
                  등을 회사에 요구할 수 있습니다.
                </div>
                <br />
                <div>
                  <b>제8조(보호조치)</b>
                  <br />
                  개인위치정보는 암호화 저장·전송하고, 접근통제·접근기록 보관·위변조 방지 등
                  안전조치를 시행합니다.
                </div>
                <br />
                <div>
