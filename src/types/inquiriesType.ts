...
export type inquirie = Database['public']['Tables']['user_inquiries']['Row'];
export type inquirieInsert = Database['public']['Tables']['user_inquiries']['Insert'];
export type inquirieUpdate = Database['public']['Tables']['user_inquiries']['Update'];
