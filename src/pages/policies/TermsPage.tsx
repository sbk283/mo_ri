        ...
        <div className="w-[1024px] h-[100%] pt-[54px] px-[77px] pb-[65px] mb-[309px] border-gray-300 border-[1px] rounded-[5px] mx-auto">
          ...
          <div className="text-md">
            ...
            <div>
              ...
              <br />
              ·개설·운영하는 회원 콘텐츠 : 회원이 서비스에 게시·업로드하는 텍스트, 사진, 영상, 후기,
              평점 등
          ...
          <div className="text-md">
            ...
            <div>
              ...
              결제대행사에 즉시 통지해야 합니다.
              <br />
              환불: 전자상거래법 등 관련 법령 및 환불정책에 따릅니다. 사용(참여) 개시 후에는 환불이
              제한될 수 있습니다.
          ...
          <div className="text-md">
            <div>
              ...
              · 안전지침 준수(현장 위험행위, 불법행위, 사기성 모집 금지) <br />· 위치정보·개인정보의
              · 무단 수집·공유 금지
            </div>
            <br />
            <div>
              ...
              · 서비스의 역설계·비인가 접근·보안 취약점 악용 <br />· 과도한 환불 유도, 티켓 재판매,
              참석 확인 조작
            </div>
            <br />
            <div>
          ...
          <div className="text-md">
            ...
            <div>
              <b>제 14조(서비스 중지·변경)</b>
              <br />
              천재지변, 정전, IDC 장애, 통신사 사정, 서비스 개편 등 불가항력 또는 상당한 사유가 있는
              경우 사전 통지 없이 중지될 수 있습니다. <br />
            ...
            <div>
              <b>제 15조(면책)</b>
              <br />
              회원의 귀책사유로 인한 손해, 제3자에 의한 비인가 접근/행위로 발생한 손해에 대해 회사는
              고의·중과실이 없는 한 책임을 지지 않습니다. <br />
