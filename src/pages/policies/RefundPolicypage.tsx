            ...
            <div className="w-[1024px] h-[100%] pt-[54px] px-[77px] pb-[65px] border-gray-300 border-[1px] rounded-[5px] mx-auto">
              ...
              <div className="text-md">
                ...
                <div>
                  <b>3. 제휴 절차</b>
                  <br />
                  문의 접수 → 1차 검토(적합성·안전성·브랜드 적합) → 제안서 교환 → 조건
                  협의(MOU/계약) → 론칭 체크리스트(브랜드 가이드, 개인정보/데이터 처리, KPI) → 성과
                  리포트
                </div>
                <br />
                <div>
                ...
                <div>
                  <b>7. 금지 사항</b>
                  <br />
                  불법/사행/혐오/차별/청소년유해 업종, 과도한 개인정보 요구, 안전 미비 활동 연계
                  등은 제휴 불가.
                </div>
                <br />
                <div>
                ...
                <div>
                  <b>9. 문의</b>
                  <br />
                  제휴 전용 이메일: [partnership@도메인] / 폼 링크: [URL] / 담당자:
                  [성명/직책/연락처]
                </div>
              </div>
            </div>
