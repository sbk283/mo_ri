  ...
  return (
    <>
      <div className=" mt-[120px] relative">
        <div className="w-[1330px] left-[149px] relative flex mb-[150px] gap-[50px]">
          {/* 이용약관 카테고리 */}
          <div className="sticky top-[120px] h-fit ">
            <div className="w-[255px] sticky top-[120px] self-start">
              ...
              <ul className="mb-6">
                <li>
                  <a
                    href="#1"
                    className="flex items-center py-[19px] w-[251px] h-[51px] pl-[19px] hover:bg-blue-50 text-[#4e4e4e] hover:text-brand cursor-pointer border border-[#F2F4F8]"
                  >
          ...
          <div className="w-[1024px] h-[100%] pt-[54px] px-[77px] pb-[65px] border-gray-300 border-[1px] rounded-[5px] mx-auto">
            ...
            <div className="text-md">
              <div id="1" className="scroll-mt-[150px]">
                <b>제 1조(목적)</b>
            ...
            <br />
            <br />
            <h2 id="2" className="text-brand font-bold text-xl scroll-mt-[100px]">
              {' '}
              제 2장 서비스 이용
            </h2>
            <br />
            ...
            <br />
            <br />
            <h2 id="3" className="text-brand font-bold text-xl scroll-mt-[100px]">
              {' '}
              제 3장 개인정보 보호
            </h2>
            <br />
            ...
            <br />
            <br />
            <h2 id="4" className="text-brand font-bold text-xl scroll-mt-[100px]">
              {' '}
              제 4장 권리와 의무
            </h2>
            <br />
            ...
            <br />
            <br />
            <h2 id="5" className="text-brand font-bold text-xl scroll-mt-[100px]">
              {' '}
              제 5장 서비스 제한
            </h2>
            <br />
