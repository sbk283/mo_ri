...
function MeetingCard({
  ...
  return (
    <div
      className="border border-[#c6c6c6] rounded-sm shadow p-4 bg-white"
      style={{ width, height }}
    >
      {/* 상단 상태 + 제목 + D-Day */}
      <div className="flex items-center justify-between px-1 gap-2 pb-5">
      ...
      {/* 대분류/중분류 + 인원/기간 */}
      <div className="flex items-center justify-between px-2 mt-14">
