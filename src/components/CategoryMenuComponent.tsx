...
function CategoryMenuComponent() {
  ...
  return (
    <aside className="w-[240px] sticky top-20">
      <Link
        to="/creategroup"
        className="flex w-[255px] h-[113px] flex-col items-center justify-center rounded-sm bg-brand shadow hover:bg-blue-600"
      >
      ...
      {/* 검색창 */}
      <div className="mt-2 relative w-[255px] h-[45px]">
        <input
          type="text"
