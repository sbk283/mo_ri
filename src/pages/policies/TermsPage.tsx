            ...
            <div className="w-[1024px] h-[100%] pt-[54px] px-[77px] pb-[65px] border-gray-300 border-[1px] rounded-[5px] mx-auto">
              ...
              <div className="text-md">
                <div>
                  ...
                  (“Mo:ri”)의 이용과 관련하여 회사와 회원 간 권리·의무 및 책임사항, 서비스 이용조건
                ...
                <div>
                  <b>제 2조(정의)</b>
                  <br />
                  ·회원 : 본 약관에 동의하고 회사가 정한 절차에 따라 계정을 생성하여 서비스를
                  이용하는 자
                  <br />
              ...
              <div className="text-md">
                <div>
                  <b>제 5조(계정 생성 및 관리)</b>
                  <br />
                  회원은 실명 기반의 정확한 정보를 제공해야 하며, 계정 보안(비밀번호, 2단계 인증
                  등)을 유지할 책임이 있습니다.
                ...
                <div>
                  ...
                  환불이 제한될 수 있습니다.
                  <br /> 모임 참가비는 플랫폼을 통한 대행 정산 또는 모임장 직접 수납 방식 중 선택될
                  수 있으며, 각 방식별 책임 범위는 별도 안내에 따릅니다.
                </div>
                <br />
                <div>
                  <b>제 8조(모임 운영 및 책임)</b>
                  <br /> 회사는 통신판매중개자에 해당할 수 있으며, 모임장과 참가자 간 분쟁의
                  당사자가 아닙니다.
                  <br />
              ...
              <div className="text-md">
                ...
                <div>
                  ...
                  <br />
                  회원은 회사에 대해 해당 콘텐츠를 서비스 운영·홍보를 위해
                  전세계적·비독점적·무상으로 저장, 복제, 공개, 배포, 2차 표시(썸네일·리사이즈)에
                  필요한 범위에서 이용할 수 있는 라이선스를 부여합니다.
                  <br />
              ...
              <div className="text-md">
                <div>
                  ...
                  조치 등을 취할 수 있습니다.
                  <br />
                  위반으로 인해 회사 또는 제3자에게 손해가 발생한 경우 해당 회원은 그 손해를
                  배상해야 합니다.
                </div>
                <br />
                <div>
                ...
                <div>
                  ...
                  회사는 회원 간 거래/약속 불이행, 분쟁에서 발생한 손해에 대해 직접적 책임이
                  없습니다.
                </div>
                <br />
                <div>
